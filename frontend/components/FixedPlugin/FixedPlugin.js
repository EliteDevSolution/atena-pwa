        ...
        <ul className="dropdown-menu">
          ...
          <li className="button-container">
            <div>
              <Button
                color="warning"
                href="https://www.creative-tim.com/product/nextjs-material-dashboard-pro?ref=njsmdp-fixed-plugin"
                target="_blank"
                fullWidth
              >
                Buy now
          ...
          <li className="button-container">
            <div>
              <Button
                color="info"
                href="https://www.creative-tim.com/learning-lab/nextjs/overview/material-dashboard?ref=njsmdp-fixed-plugin"
                target="_blank"
                fullWidth
              >
                Documentation
